...
export default function About() {
  const config = {
    line1:
      "Hi, My name is Shamini. I am a Full stack web developer. I built beautiful Websites with Reacjs and TailwindCSS + Bootstrap",
    line2:
      "I am proficient in Frontend skills like React.js, Redux, Redux ToolKit, Axios, Tailwind CSS, SaSS, Css3 and many more.",
    line3: "In backend I know Node.js, Express.js, MogoDB and Mongoose",
  };
  return (
